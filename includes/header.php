...
<head>
    ...
    <link rel="stylesheet" href="/SIRSHOP/assets/toko.css">
    ...
    <style>
        ...
        /* Tema Dark dari cloningwebsite.md */
        .navbar-custom {
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?= BASE_URL ?>cek_transaksi.php">Cek Transaksi</a>
                    </li>
                    ...
                    <?php if (isset($_SESSION['username'])): ?>
                        <li class="nav-item ms-lg-3">
                            <a class="nav-link" href="/SIRSHOP/admin/dashboardadmin.php">Hi, Admin</a>
                        </li>
